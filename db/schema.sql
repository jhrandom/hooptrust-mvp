-- HoopTrust MVP Supabase/Postgres schema draft
-- Run this after creating a Supabase project. Review policies before production.
...
create policy "Players can update own player record" on public.players for update using (user_id = auth.uid());
