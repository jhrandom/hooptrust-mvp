...
export default async function ContactRequestsPage() {
  ...
  const { data: requests } = player
    ...
    : { data: [] };
  return <main className="container-page py-10"><h1 className="text-3xl font-black text-ink">Contact requests</h1><p className="mt-2 text-muted">Approve only recruiters you are comfortable contacting.</p><div className="mt-8"><ContactDecisionList initialRows={(requests ?? []) as never[]} /></div></main>;
}
